...
export default class HandGestureView {
    ...
    constructor({ fingerLookupIndexes, styler }) {
        ...
        // carrega os estilos de forma assyncrona (evita travar a tela enquanto carrega)
    ...
    #hoverElement(finger, points) {
        ...
        const dispathHover = () => this.#styler.toggleStyle(element, ':hover');
        dispathHover();
        setTimeout(dispathHover, 500)
    }
